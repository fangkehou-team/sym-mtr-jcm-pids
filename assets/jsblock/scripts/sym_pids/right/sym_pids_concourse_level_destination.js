...
function render(ctx, state, pids) {
    ...
    Texture.create("Background")
        .texture("jsblock:custom_directory/sym_pids/right/pids_concourse_level_destination.png")
        .size(pids.width, pids.height)
        .draw(ctx);

    // station names
    let station = pids.station().name;
    ...
    Text.create("main_station_name")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1488.949, 222.101), calculateHeight(pids_size, 76.947))
        .size(calculateWidth(pids_size, 507.157), calculateHeight(pids_size, 110))
        .scaleXY()
        .draw(ctx);
    ...
    Text.create("extra_station_name")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1417.216, 365.568), calculateHeight(pids_size, 175.723))
        .size(calculateWidth(pids_size, 507.157), calculateHeight(pids_size, 100))
        .scaleXY()
        .draw(ctx);
    ...
    Text.create("time")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1426.340, 347.408), calculateHeight(pids_size, 326.391))
    ...
    Text.create("date")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1367.397, 146.133), calculateHeight(pids_size, 425.314))
    ...
    Text.create("week")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1605.873, 231.693), calculateHeight(pids_size, 425.314))
