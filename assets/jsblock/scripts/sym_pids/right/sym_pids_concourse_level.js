...
function drawArriving(ctx, pids_size, eta, height_start) {
    if (eta > 0) {
        Text.create("arrived_chinese")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, height_start + 17.679))
        ...
        Text.create("arrived_chinese")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, height_start))
        ...
        Text.create("arrived_english")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, height_start + 69.892))
...
function render(ctx, state, pids) {
    ...
    Texture.create("Background")
        .texture("jsblock:custom_directory/sym_pids/right/pids_concourse_level.png")
    ...
    Text.create("time")
        ...
        .scale(1)
        .centerAlign()
        .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, 50.000))
    ...
    if (arrival_first != null) {
        ...
        Text.create("main_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, 224.946))
        ...
        Text.create("extra_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, 309.658))
    ...
    if (arrival_second != null) {
        ...
        Text.create("main_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, 622.172))
            .size(calculateWidth(pids_size, 507.157), calculateHeight(pids_size, 68.843))
            .scaleXY()
            .draw(ctx);
        ...
        Text.create("extra_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1375.456, 449.089), calculateHeight(pids_size, 706.884))
            .size(calculateWidth(pids_size, 507.157), calculateHeight(pids_size, 40.480))
            .scaleXY()
            .draw(ctx);
    ...
    Text.create("top_row")
        ...
        .scale(0.6)
        // .centerAlign()
        .pos(calculateWidth(pids_size, 208.634), calculateHeight(pids_size, 43.404))
    ...
    Text.create("bottom_row")
        ...
        .scale(0.8)
        // .centerAlign()
        .pos(calculateWidth(pids_size, 405.865), calculateHeight(pids_size, 941.075))
