...
function render(ctx, state, pids) {
    ...
    Texture.create("Background")
        .texture("jsblock:custom_directory/sym_pids/right/pids_platform_level_destination.png")
    ...
    if (arrival_first != null) {
        ...
        Text.create("main_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1488.949, 222.101), calculateHeight(pids_size, 118.947))
        ...
        Text.create("extra_station_name")
            ...
            .scale(1)
            .centerAlign()
            .pos(calculateCenterWidth(pids_size, 1417.216, 365.568), calculateHeight(pids_size, 211.627))
